...
namespace SevenZipSharpSimple.Interop
{
    ...
    internal interface IArchiveExtractCallback
    {
        ...
        /// <summary>
        /// The decompressor requests access to a writeable stream (<see cref="IOutputStream"/>) for the <see cref="ArchiveEntry"/> with
        ...
        /// <param name="writer">The pointer to assign the <see cref="IOutputStream"/> to.</param>
        ...
        [PreserveSig]
        int GetStream(uint index, [MarshalAs(UnmanagedType.Interface)] out IOutputStream writer, ExtractOperation operation);

        /// <summary>
        /// The decompressor calls this method directly after <see cref="GetStream(uint, out IOutputStream, ExtractOperation)"/> to indicate
        ...
        /// <summary>
        /// The decompressor calls this method to indicate the result of the operation that was initiated with a call to <see cref="GetStream(uint, out IOutputStream, ExtractOperation)"/>.
        ///
        /// Resources create within <see cref="GetStream(uint, out IOutputStream, ExtractOperation)"/> should now be freed again to avoid any kind of leaks or high memory usage.
        /// </summary>
